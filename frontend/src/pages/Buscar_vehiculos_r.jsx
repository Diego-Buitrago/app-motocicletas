...
const Buscar_vehi_r = () => {
    ...
    return (
        <>
            ...
            <h1 className="h1-crear-usuario">Buscar vehiculos</h1>
            
            <form id="form" onSubmit={(e)=>Buscar(e)} className="form-group">
                <table  className="table table-Info mt-5" id="table-registrar">
                        ...
                        <td>
                            {
                                marca === 'AKT' ? (
                                    ...
                                    <select value={linea} onChange={(e)=>setLinea(e.target.value)}>
                                        ...
                                        <option value="CB125F TWISTER">CB125F TWISTER</option>
                    ...
                    <tr>
                        <td align="center"><button onClick={() => {Borrar()}} className="btn btn-dark">Borrar</button></td>
                        <td align="center"><input className="btn btn-success btn-block" type="submit" value="Buscar"/></td>
                    </tr>
                </table>
                {
