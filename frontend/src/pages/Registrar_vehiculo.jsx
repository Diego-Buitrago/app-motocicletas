...
const Registrar = () => {
    ...
    const insertar = (e) => {
        ...
        } else if(fecha_ven_tecnomecanica === '') {
            setError('Ingresa la fecha en la que vence la tecnomecanica')
        }else {
            fetch("/registrar_vehiculo", {
                method: "POST",
                headers: {
    ...
    return (
        <>
            ...
            <h1 className="h1-crear-usuario">Registrar vehiculo</h1>
            ...
            <form id="form" onSubmit={(e)=>insertar(e)} className="form-group">
                <table  className="table table-Info mt-5" id="table-registrar">
                    ...
                    <tr>
                        <td align="center" colSpan="2"><input className="btn btn-success btn-block" type="submit" value="Registrar"/></td>
                    </tr>
                </table>
                {
                    error != null ? (
